const CACHE='sideline-stats-v4-5-8-voice-play-entry';
const ASSETS=['./','./index.html','./styles.css','./voice-play.js','./app.js','./pwa.js','./brand-header.png','./brand-field.png','./icon.png','./snap-tracker.html','./snap-tracker.js'];
