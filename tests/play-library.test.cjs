...
assert.match(html, /V4\.5\.17/, 'the visible build label must identify V4.5.17');
...
assert.match(app, /source==="auto"/, 'new games must automatically use the most recent available game plan');
