...
assert.match(app, /cloudPendingCount\(\)>0,delay=succeeded\?250/, 'pending changes must schedule another upload pass');
...
assert.match(sw, /sideline-stats-v4-5-51-interception-voice-roles/, 'service worker cache must match the current release');
