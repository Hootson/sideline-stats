const CACHE="hardcourt-ui51-20260921";
const ASSETS=["./","./index.html","./styles.css?v=ui51","./app.js?v=ui51","./engine.js","./manifest.webmanifest?v=ui51","./court-iphone.png","./court-ipad.png","./court-analytics.png"];
