const CACHE="hardcourt-ui53-20260921";
const ASSETS=["./","./index.html","./styles.css?v=ui53","./app.js?v=ui53","./engine.js","./manifest.webmanifest?v=ui53","./court-iphone.png","./court-ipad.png","./court-analytics.png"];
