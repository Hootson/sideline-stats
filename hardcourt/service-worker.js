const CACHE="hardcourt-ui52-20260921";
const ASSETS=["./","./index.html","./styles.css?v=ui52","./app.js?v=ui52","./engine.js","./manifest.webmanifest?v=ui52","./court-iphone.png","./court-ipad.png","./court-analytics.png"];
