const CACHE="hardcourt-ui66-20260922";
const ASSETS=["./","./index.html","./styles.css?v=ui53","./app.js?v=20260922-ui66","./engine.js","./manifest.webmanifest?v=ui53","./court-iphone.png","./court-ipad.png","./court-analytics.png","./hardcourt-header-arena.png?v=ui66"];
