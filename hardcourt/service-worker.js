const CACHE="hardcourt-ui50-20260921";
const ASSETS=["./","./index.html","./styles.css?v=ui50","./app.js?v=ui50","./engine.js","./manifest.webmanifest?v=ui50","./court-iphone.png","./court-ipad.png","./court-analytics.png"];
