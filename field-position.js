(function(root,factory){
  ...
  function installInteractivePicker(){
    ...
    style.textContent=`
      ...
      .ss-yard-numbers{position:absolute;left:0;right:0;top:16px;display:grid;grid-template-columns:repeat(10,1fr);pointer-events:none}
      .ss-yard-numbers.bottom{top:auto;bottom:16px}
      .ss-yard-numbers span{color:#fff;font-size:11px;font-weight:950;text-align:center;text-shadow:0 1px 3px #0008}
      ...
      .ss-field-selection strong{color:var(--p);font-size:17px}.ss-field-selection span{font-size:12px;color:var(--muted);text-align:right}
      .ss-field-quick{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:8px}
      .ss-field-quick button{border:1px solid var(--line);background:#fff;color:var(--p);border-radius:10px;padding:9px;font-weight:900;font-size:12px}
    `;
    ...
    picker.innerHTML=`
      ...
      <div class="ss-field-shell" id="ssFieldShell" role="slider" aria-label="Ball position" aria-valuemin="0" aria-valuemax="100" tabindex="0">
        <div class="ss-field-endzones">
          ...
          <div class="ss-field" id="ssFieldSurface">
            ...
            <div class="ss-yard-numbers"><span>10</span><span>20</span><span>30</span><span>40</span><span>50</span><span>40</span><span>30</span><span>20</span><span>10</span><span>G</span></div>
            <div class="ss-yard-numbers bottom"><span>10</span><span>20</span><span>30</span><span>40</span><span>50</span><span>40</span><span>30</span><span>20</span><span>10</span><span>G</span></div>
      ...
      <div class="ss-field-quick"><button type="button" id="ssFieldMinus">− 1 yard</button><button type="button" id="ssFieldPlus">+ 1 yard</button></div>
    `;
    ...
    const minus=document.getElementById("ssFieldMinus");
    const plus=document.getElementById("ssFieldPlus");
    ...
    const possession=()=>/Opponent|Defense/i.test(document.getElementById("possessionMain")?.textContent||"")?"opp":"ours";
    ...
    minus.addEventListener("click",()=>commit(selected-1));
    plus.addEventListener("click",()=>commit(selected+1));
    ...
    const refresh=()=>{
      ...
      const initial=current===null?25:current;
