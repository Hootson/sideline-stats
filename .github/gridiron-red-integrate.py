...
# Voice follow-up UI: preserve parsed facts and offer one-tap answers for missing type/player.
...
print('Gridiron red modules + voice missing-info workflow integrated safely')
